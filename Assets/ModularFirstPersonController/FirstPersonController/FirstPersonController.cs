...
public class FirstPersonController : MonoBehaviour
{
    ...
    //public GameObject meshAnimation;
    ...
    void Start()
    {
        //animator=meshAnimation.GetComponent<Animator>();
    ...
    void FixedUpdate()
    {
        ...
        {*/
            ...
            if (playerCanMove)
            {
                ...
                /*if(isWalking)animator.SetBool("isRunning", true);
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        //fpc.meshAnimation = (GameObject)EditorGUILayout.ObjectField(new GUIContent("mesh with animation", "Add the gameobject containing mesh and animation"), fpc.meshAnimation, typeof(GameObject), true);
